  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <main className="pt-24 pb-16 container mx-auto px-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center text-blue-900">TechEdu Lab 소개</h1>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center text-blue-900">우리의 비전</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Card key={index} className="backdrop-blur-md bg-white/90 border border-gray-200 shadow-md">
                <CardContent className="p-6 text-center">
                  <h3 className="text-xl font-bold mb-3 text-blue-800">{vision.title}</h3>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center text-blue-900">창업팀</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {['CEO & 하드웨어 엔지니어', '교육 콘텐츠 디렉터', '소프트웨어 개발자'].map((role, index) => (
              <Card key={index} className="backdrop-blur-md bg-white/90 border border-gray-200 shadow-md">
                <CardContent className="p-6 text-center">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-600 to-blue-900 mx-auto mb-4"></div>
                  <h3 className="text-xl font-bold mb-1 text-blue-800">팀원 {index + 1}</h3>
