  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <main className="pt-24 pb-16 container mx-auto px-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center">TechEdu Lab 소개</h1>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">우리의 비전</h2>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">창업팀</h2>
            ...
            {['CEO & 하드웨어 엔지니어', '교육 콘텐츠 디렉터', '소프트웨어 개발자'].map((role, index) => (
              <Card key={index} className="backdrop-blur-md bg-white/5 border-white/10">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-xl font-bold mb-1">팀원 {index + 1}</h3>
